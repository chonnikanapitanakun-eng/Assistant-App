...
- Auth + cloud sync: [docs/SYNC.md](docs/SYNC.md)
...
src/features/     tasks / notes / money / contacts / areas / search / ai / auth / sync
...
supabase/         migrations (ai_usage, gcal, sync_rows), Edge Functions (AI, gcal)
docs/             SPEC, ROADMAP, SYNC
```
