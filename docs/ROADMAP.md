...
- [x] Gmail: inbox ค้างตอบ, สรุป, draft, follow-up reminder (P4-01) — ใช้เองเท่านั้น (OAuth client แยก, โหมด Testing)
- [ ] Google OAuth verification เฟส A: sign-in + Calendar (sensitive, ไม่ต้อง CASA)
- [ ] Gmail สำหรับทุกคน: verification + CASA (restricted) — แผน: `docs/GMAIL_OAUTH_VERIFICATION.md`
