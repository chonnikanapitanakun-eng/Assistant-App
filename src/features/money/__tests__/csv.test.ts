...
const wallet = (o: Partial<Wallet>): Wallet => ({ id: 'w1', name: 'Cash', type: 'cash', currency: 'THB', balance: 0, color: null, sortOrder: 0, userId: null, createdAt: 0, updatedAt: 0, deletedAt: null, syncedAt: null, ...o });
...
const tx = (o: Partial<Transaction>): Transaction => ({
  id: 't1', walletId: 'w1', amount: 100, currency: 'THB', type: 'expense', toWalletId: null, categoryId: null, areaId: null, date: '2026-09-10', note: null, slipImage: null, source: 'manual',
