    ...
    <Screen>
        ...
        <View style={{ flexDirection: 'row', gap: spacing.sm }}>
          {priorities.map((p) => (
            <Pressable
              ...
              style={{ paddingVertical: 8, paddingHorizontal: 16, borderRadius: radius.pill, backgroundColor: priority === p ? colors.primary : colors.surfaceMuted }}
            >
        ...
        <View style={{ flexDirection: 'row', gap: spacing.sm }}>
          {energies.map((e) => (
            <Pressable
              ...
              style={{ paddingVertical: 8, paddingHorizontal: 16, borderRadius: radius.pill, backgroundColor: energy === e ? colors.primary : colors.surfaceMuted }}
            >
      ...
      <View style={{ gap: spacing.sm }}>
        ...
        <View style={{ flexDirection: 'row', gap: spacing.sm }}>
          ...
          />
          <Pressable onPress={addChecklistItem} style={{ width: 48, borderRadius: radius.md, backgroundColor: colors.surfaceMuted, alignItems: 'center', justifyContent: 'center' }}>
